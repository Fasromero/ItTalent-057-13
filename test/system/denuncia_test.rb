...
class DenunciaTest < ApplicationSystemTestCase
  ...
  test "creating a Denuncium" do
    ...
    fill_in "Descripciondeldelito", with: @denuncium.descripcionDelDelito
    fill_in "Fechadeldelito", with: @denuncium.fechaDelDelito
    fill_in "Lugardeldelito", with: @denuncium.lugarDelDelito
    fill_in "Nombredeldenunciante", with: @denuncium.nombreDelDenunciante
