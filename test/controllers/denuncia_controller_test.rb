...
class DenunciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create denuncium" do
    assert_difference('Denuncium.count') do
      post denuncia_url, params: { denuncium: { descripcionDelDelito: @denuncium.descripcionDelDelito, fechaDelDelito: @denuncium.fechaDelDelito, lugarDelDelito: @denuncium.lugarDelDelito, nombreDelDenunciante: @denuncium.nombreDelDenunciante } }
    end
  ...
  test "should update denuncium" do
    patch denuncium_url(@denuncium), params: { denuncium: { descripcionDelDelito: @denuncium.descripcionDelDelito, fechaDelDelito: @denuncium.fechaDelDelito, lugarDelDelito: @denuncium.lugarDelDelito, nombreDelDenunciante: @denuncium.nombreDelDenunciante } }
